...
$lang['package_registry_tip'] = 'The package registry repository used for updates and package installation. Leave empty to use the official registry (recommended).';
