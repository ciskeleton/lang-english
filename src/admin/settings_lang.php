...
$lang['allowed_types_tip'] = 'List of files that are allowed to be uploaded. Use "&#124;" to separate types.';
$lang['app_github_token'] = 'GitHub Access Token';
$lang['app_github_token_tip'] = 'GitHub access token used to access the application\'s private repository.';
...
$lang['enable_profiler_tip'] = 'Display benchmark results, queries you have run, and other information.';
...
$lang['login_alert_failure_tip'] = 'Alert users about any failed login attempts on their account.';
$lang['login_alert_success_tip'] = 'Notify users about any successful logins to their account.';
...
$lang['offline_access_level_tip'] = 'The minimum access level able to log in while in maintenance mode.';
$lang['package_registry'] = 'Package Registry';
$lang['package_registry_tip'] = 'The package registry used for updates and package installation. Leave empty to use the official registry (recommended).';
...
$lang['server_email_tip'] = 'The email address used to send emails to users. Used as the "From" address. You can use "noreply@..." or an existing email address.';
...
$lang['site_demo_tip'] = 'Choose whether to put the site in demo mode.';
...
$lang['site_offline_tip'] = 'Select whether access to the site frontend is available.';
...
$lang['smtp_host_tip'] = 'Enter the SMTP host name (e.g., smtp.gmail.com). Required only if using the SMTP protocol.';
...
$lang['update_check_enabled_tip'] = 'When enabled, the system periodically checks for new updates.';
...
$lang['use_manifest_tip'] = 'A "manifest.json" file is a JSON file that provides metadata about a site or web application, primarily to improve how the site behaves on mobile devices and how it can be added to the user’s home screen as a Progressive Web App (PWA).';
$lang['use_recaptcha'] = 'Use reCAPTCHA';
$lang['use_recaptcha_tip'] = 'Whether to use Google reCAPTCHA. Requires valid site and secret keys, and CAPTCHA must be enabled.';
